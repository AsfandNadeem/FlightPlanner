(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function rn0(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(userService, router) {
          ...
          this.message = '';
          this.userService.getLoginErrors().subscribe(function (error) {
            _this.message = error;
          });
        }
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\FlightPlannerTask\AngularFrontEnd\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function si1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Uoe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function esG(module, __webpack_exports__, __webpack_require__) {
      ...
      var AdminService = /*#__PURE__*/function () {
        ...
        _createClass(AdminService, [{
          ...
          value: function login(userName, password) {
            ...
            this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiBaseUrl + '/admin/login', {
              userName: userName,
              password: password
            }).subscribe(function (response) {
              _this2.isadmin = true;

              _this2.router.navigate(['/cities']).then();
            }, function (error) {
              console.log('invalid admin');
              _this2.isadmin = false;

              _this2.router.navigate(['/admin']).then();
            });
          }
        }, {
          key: "addCity",
          value: function addCity(name, country) {
            console.log(name + '' + country);
            return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiBaseUrl + '/admin/city', {
              name: name,
              country: country
            });
          }
          ...
          key: "addFlight",
          value: function addFlight(origin, destination, cost) {
            console.log(origin + '' + destination + '' + cost);
            return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiBaseUrl + '/admin/addflight', {
              origin: origin,
          ...
          key: "getOrigins",
          value: function getOrigins() {
            var _this3 = this;

            this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiBaseUrl + '/admin/getOrigin').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (originData) {
              return {
                origins: originData.cities.map(function (origin) {
                  return {
                    name: origin.name,
                    _id: origin._id
                  };
            ...
            .subscribe(function (transformedOriginsData) {
              _this3.origins = transformedOriginsData.origins;

              _this3.originsUpdated.next({
                origins: _toConsumableArray(_this3.origins),
                maxCities: transformedOriginsData.maxCities
              });
            });
          }
        }, {
          key: "getOriginsUpdateListener",
          value: function getOriginsUpdateListener() {
            return this.originsUpdated.asObservable();
          }
        }, {
          key: "getDestinations",
          value: function getDestinations(id) {
            var _this4 = this;

            console.log(id);
            this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiBaseUrl + '/admin/getDestination/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (destinationData) {
              return {
                destinations: destinationData.cities.map(function (destination) {
                  return {
            ...
            .subscribe(function (transformedDestinationsData) {
              _this4.destinations = transformedDestinationsData.destinations;

              _this4.destinationsUpdated.next({
                destinations: _toConsumableArray(_this4.destinations),
                maxCities: transformedDestinationsData.maxCities
              });
            });
          }
        }, {
          key: "getDestinationsUpdateListener",
          value: function getDestinationsUpdateListener() {
      ...
      AdminService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AdminService);
      /***/
    },
    ...
    function zNF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_cities_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./cities.component.html */
      "CrY6");
      /* harmony import */


      var _cities_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _shared_admin_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../shared/admin.service */
      "2esG");

      var CitiesComponent = /*#__PURE__*/function () {
        function CitiesComponent(adminService) {
        ...
        _createClass(CitiesComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.originSub = this.adminService.getOriginsUpdateListener().subscribe(function (originData) {
              _this5.origins = originData.origins;
            });
          }
        }, {
          key: "addCity",
          value: function addCity(form) {
            var _this6 = this;
            ...
            this.adminService.addCity(form.value.cityName, form.value.countryname).subscribe(function (res) {
              _this6.showSucessMessage = true;
              setTimeout(function () {
                return _this6.showSucessMessage = false;
              }, 4000);

              _this6.adminService.getOrigins();

              _this6.resetForm(form);
            }, function (err) {
              _this6.serverErrorMessages = 'Something went wrong';
            });
          }
        }, {
          key: "resetForm",
      ...
      CitiesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-cities',
      ...
      var UserService = /*#__PURE__*/function () {
        ...
        _createClass(UserService, [{
          ...
          value: function login(email, password) {
            ...
            return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiBaseUrl + '/user/login', {
              email: email,
              password: password
            }).subscribe(function (response) {
              ...
              if (token) {
                ...
                _this7.userId = response.userId;
                _this7.userN = response.username;
                ...
                _this7.saveAuthData(token, expirationDate, _this7.userId, _this7.userN);

                _this7.message = '';

                _this7.logInErrorSubject.next(_this7.message);

                _this7.router.navigate(['/flightplan']).then();
              }
            }, function (error) {
              _this7.message = 'invalid Email or Password';
          ...
          key: "saveAuthData",
          value: function saveAuthData(token, expirationDate, userId, userNam) {
    ...
    /***/
    function CrY6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Iyt7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JEc0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function PwBB(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_flights_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./flights.component.html */
      "0si1");
      /* harmony import */


      var _flights_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _shared_admin_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../shared/admin.service */
      "2esG");

      var FlightsComponent = /*#__PURE__*/function () {
        function FlightsComponent(adminService) {
        ...
        _createClass(FlightsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.adminService.getOrigins();
            this.originSub = this.adminService.getOriginsUpdateListener().subscribe(function (originData) {
              _this9.origins = originData.origins;
            });
          }
        }, {
          key: "getDestinations",
          value: function getDestinations(event) {
            var _this10 = this;

            this.adminService.getDestinations(event._id);
            this.destinationSub = this.adminService.getDestinationsUpdateListener().subscribe(function (destinationData) {
              _this10.destinations = destinationData.destinations;
            });
          }
        }, {
          key: "onSaveFlight",
          value: function onSaveFlight() {
            var _this11 = this;
            ...
            this.adminService.addFlight(this.form.value.OriginControl._id, this.form.value.DestinationControl._id, this.form.value.CostControl).subscribe(function (res) {
              ...
              _this11.serverErrorMessages = 'Something went wrong';
            });
          }
        }]);
      ...
      FlightsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function RagP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function SZmd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_sign_up_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    /***/
    function Ugab(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Uxgr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function X76u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_auth_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var ngx_auto_scroll__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ngx-auto-scroll */
      "C7wj");
      /* harmony import */
      ...
      var _user_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      ...
      var _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./admin/admin-login/admin-login.component */
      "Iyt7");
      /* harmony import */


      var _admin_cities_cities_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./admin/cities/cities.component */
      "8zNF");
      /* harmony import */


      var _admin_flights_flights_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./admin/flights/flights.component */
      "PwBB");
      /* harmony import */


      var _user_login_login_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./user/login/login.component */
      "+rn0");
      /* harmony import */


      var _user_flight_plan_flight_plan_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./user/flight-plan/flight-plan.component */
      "ddat"); //builtin imports
      //components
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_14__["AppComponent"], _user_user_component__WEBPACK_IMPORTED_MODULE_15__["UserComponent"], _user_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_16__["SignUpComponent"], _admin_admin_component__WEBPACK_IMPORTED_MODULE_17__["AdminComponent"], _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_18__["AdminLoginComponent"], _admin_cities_cities_component__WEBPACK_IMPORTED_MODULE_19__["CitiesComponent"], _admin_flights_flights_component__WEBPACK_IMPORTED_MODULE_20__["FlightsComponent"], _user_login_login_component__WEBPACK_IMPORTED_MODULE_21__["LoginComponent"], _user_flight_plan_flight_plan_component__WEBPACK_IMPORTED_MODULE_22__["FlightPlanComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_10__["MatInputModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_9__["MatCardModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_11__["MatSelectModule"], ngx_auto_scroll__WEBPACK_IMPORTED_MODULE_12__["NgxAutoScrollModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_13__["MatListModule"]],
        providers: [{
          provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"],
          useClass: _shared_auth_interceptor__WEBPACK_IMPORTED_MODULE_7__["AuthInterceptor"],
          multi: true
    ...
    /***/
    function ZU6k(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ddat(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FlightPlanComponent", function () {
        return FlightPlanComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_flight_plan_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./flight-plan.component.html */
      "JEc0");
      /* harmony import */


      var _flight_plan_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./flight-plan.component.css */
      "ZU6k");
      /* harmony import */
      ...
      var FlightPlanComponent = /*#__PURE__*/function () {
        function FlightPlanComponent(adminService) {
          _classCallCheck(this, FlightPlanComponent);
        ...
        _createClass(FlightPlanComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this13 = this;
            ...
            this.adminService.getOrigins();
            this.originSub = this.adminService.getOriginsUpdateListener().subscribe(function (originData) {
              _this13.origins = originData.origins;
            });
          }
        }, {
          key: "getDestinations",
          value: function getDestinations(event) {
            ...
            this.adminService.getDestinations(event._id);
            this.destinationSub = this.adminService.getDestinationsUpdateListener().subscribe(function (destinationData) {
              _this14.destinations = destinationData.destinations;
            });
          }
        }]);
      ...
      FlightPlanComponent.ctorParameters = function () {
        return [{
          type: _shared_admin_service__WEBPACK_IMPORTED_MODULE_5__["AdminService"]
        }];
      };

      FlightPlanComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function fPxl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function q12R(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function tude(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _user_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./user/sign-up/sign-up.component */
      "SZmd");
      /* harmony import */
      ...
      var _admin_admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./admin/admin-login/admin-login.component */
      "Iyt7");
      /* harmony import */


      var _admin_cities_cities_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./admin/cities/cities.component */
      "8zNF");
      /* harmony import */


      var _admin_flights_flights_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./admin/flights/flights.component */
      "PwBB");
      /* harmony import */


      var _user_login_login_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./user/login/login.component */
      "+rn0");
      /* harmony import */


      var _user_flight_plan_flight_plan_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./user/flight-plan/flight-plan.component */
      "ddat");
      /* harmony import */
      ...
      var routes = [{
        ...
        children: [{
          path: '',
          component: _user_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_3__["SignUpComponent"]
        }]
      }, {
        path: 'login',
        component: _user_user_component__WEBPACK_IMPORTED_MODULE_4__["UserComponent"],
        ...
        path: 'cities',
        component: _admin_cities_cities_component__WEBPACK_IMPORTED_MODULE_7__["CitiesComponent"]
      }, {
        path: 'flights',
        component: _admin_flights_flights_component__WEBPACK_IMPORTED_MODULE_8__["FlightsComponent"]
      }, {
        path: 'flightplan',
        component: _user_flight_plan_flight_plan_component__WEBPACK_IMPORTED_MODULE_10__["FlightPlanComponent"],
    ...
    /***/
    function xFpS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
